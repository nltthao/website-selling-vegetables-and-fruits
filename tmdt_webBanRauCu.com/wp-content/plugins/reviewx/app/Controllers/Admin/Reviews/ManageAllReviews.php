...
class ManageAllReviews extends WordpressListTable
{
    ...
    public function wp_list_table_data()
    {
        ...
        foreach ($comments as $comment) {
            ...
            $comment_date = strtotime(get_comment_date('Y-m-d H:i:s', $comment));
            $one_hour_ago_timestamp = $comment_date - 14400;
            $submitted = sprintf(
                ...
                // // get_comment_date(__('Y/m/d', 'reviewx'), $comment),
                // /* translators: Review time format. See https://www.php.net/manual/datetime.format.php */
              date('Y-m-d H:i a', $one_hour_ago_timestamp)
