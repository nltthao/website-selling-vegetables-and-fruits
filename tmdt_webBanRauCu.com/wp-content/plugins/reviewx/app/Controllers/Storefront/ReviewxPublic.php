                ...
                echo '<div class="form-group">
                        <div class="rx-images rx-flex-grid-100" id="rx-images">
                            <p class="rx-comment-form-attachment">
                                ...
                                <input id="attachment" name="attachment" type="file" accept=".png, .jpg" ' . apply_filters('rx_multiple_image_upload', 1) . '/>
...
<?php
    ...
    public function reviewx_load_review_list($atts)
    {
        ...
        $reviewx_shortcode['rx_pagination']     = esc_js($atts['pagination']);
